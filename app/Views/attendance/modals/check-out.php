            ...
            <div x-show="isOpen"
                    ...
                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                Ingrese el DNI del empleado para registrar su salida.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <form @submit.prevent="handleSubmit" class="mt-5">
                    <div class="space-y-4">
                        <!-- Campo DNI -->
                        <div>
                            <label for="dni_out" class="block text-sm font-medium text-gray-700">
                                DNI del Empleado
                            </label>
                            <input type="text" 
                                   id="dni_out" 
                        ...
                        <!-- Campo Ubicación -->
                        <div>
                            <label for="location_out" class="block text-sm font-medium text-gray-700">
                                Ubicación de Salida
                            </label>
                            <input type="text" 
                                   id="location_out" 
